...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SCSDKBitmojiKit/SCSDKBitmojiKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SCSDKCoreKit/SCSDKCoreKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SCSDKCreativeKit/SCSDKCreativeKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SCSDKLoginKit/SCSDKLoginKit.framework"
fi
